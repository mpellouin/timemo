...
@UnitTest
class TimemoCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class TimemoCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = TimemoCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = TimemoCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class TimemoCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = TimemoCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = TimemoCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class TimemoCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = TimemoCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = TimemoCollections.immutable(input);
  ...
  class TimemoMapTest {
    ...
    void shouldGetEmptyImmutableMapFromNullMap() {
      ...
      Map<Object, Object> map = TimemoCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = TimemoCollections.immutable(input);
